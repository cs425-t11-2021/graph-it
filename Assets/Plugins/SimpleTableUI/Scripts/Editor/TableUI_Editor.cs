...
namespace Plugins.SimpleTableUI.Scripts.Editor
{
    [CustomEditor(typeof(TableUI))]
    public class TableUI_Editor : UnityEditor.Editor
    {
        TableUI tu;
        ...
        UnityEditor.Editor bodyCellPropertiesEditor,headerCellPropertiesEditor;
