...
public class CameraPan : MonoBehaviour
{
    ...
    private void Update() {
        ...
        if (Controller.Singleton.GraphObjContainer.childCount == 0) {
            this.doNotPan = true;
            return;
        }
        ...
        if (Input.GetMouseButtonDown(0)) {
            ...
            lastPosition = InputManager.Singleton.CursorWorldPosition;
        ...
        if (Input.GetMouseButton(0)) {
            ...
            Vector3 dir = lastPosition - InputManager.Singleton.CursorWorldPosition;
    ...
    {
        Transform graphObj = Controller.Singleton.GraphObjContainer;
