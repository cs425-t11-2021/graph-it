...
public class AlgorithmInitiationState : ManipulationState
{
    ...
    public override void OnStateEnter()
    {
        ...
        NotificationManager.Singleton.CreateNoficiation(string.Format("Please select {0} vertices for {1}.", this.currentAssociation.requiredVertices, this.currentAssociation.algorithmClass), 5);
    }
