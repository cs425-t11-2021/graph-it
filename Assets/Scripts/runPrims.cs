 ...
 * if the algorithm runs, the results will be displayed to the user
 * pop-up will most likely be over the algorithms panel to not interfere with the graph
 */
...
public class runPrims : MonoBehaviour
{
