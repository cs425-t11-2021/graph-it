...
public class BellmanFordsAlgorithm : Algorithm
{
    ...
    public BellmanFordsAlgorithm( AlgorithmManager algoManager, Vertex src, Vertex dest ) : base( algoManager, algoManager.bellmanFordsUI, algoManager.bellmanFordsCalc )
    {
        this.src = src;
        this.dest = dest;
    }
